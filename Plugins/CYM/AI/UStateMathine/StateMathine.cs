...
namespace CYM.AI.USM
{
        ...
        where TStateData : CharaState<TState, TUnit>, new()
    {
        ...
        {
            int intCurState = Enum<TState>.Int(CurState);
            int intNextState = Enum<TState>.Int(state);
        ...
        {
            int intstate = Enum<TState>.Int(state);
        ...
        {
            int intState = Enum<TState>.Int(CurState);
            int intstate = Enum<TState>.Int(state);
