...
namespace CYM.TGS {
    ...
    public partial class TGS : MonoBehaviour {
        ...
        Vector2 _cellSize;
        [SerializeField]
        Color _cellBorderColor = new Color(0, 1, 0, 1.0f);
        [SerializeField]
        float _cellBorderThickness = 1f;
        [SerializeField]
        float _cellFillPadding;
        [SerializeField]
        Color _cellHighlightColor = new Color(1, 0, 0, 0.8f);
        [SerializeField]
        Color _cellHighlightColor2 = new Color(0, 1, 0, 0.8f);
        [SerializeField]
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Texture2D texture) {
            return CellToggleRegionSurface(cellIndex, visible, Color.white, false, texture, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false);
        }
        /// <summary>
        /// Colorize specified region of a cell by indexes.
        /// </summary>
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry = false) {
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, null, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false);
        }
        /// <summary>
        /// Colorize specified region of a cell by indexes.
        /// </summary>
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, Texture2D texture) {
            return CellToggleRegionSurface(cellIndex, visible, color, refreshGeometry, texture, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false);
        }
        /// <summary>
        /// Colorize specified region of a cell by indexes.
        /// </summary>
        ...
        public GameObject CellToggleRegionSurface(int cellIndex, bool visible, Color color, bool refreshGeometry, Texture2D texture, Vector2 textureScale, Vector2 textureOffset, float textureRotation, bool overlay, bool rotateInLocalSpace) {
            ...
            if (isHighlighted && region.customMaterial != null && _highlightedObj != null) {
                if (hudMatCell.HasProperty(TGSConst.MainTex)) {
        ...
        public void CellFadeOut(int cellIndex, Color color, float duration = 2f, int repetitions = 1) {
            CellAnimate(FADER_STYLE.FadeOut, cellIndex, TGSConst.ColorNull, color, duration, repetitions);
        }
        /// <summary>
        ...
        public void CellFadeOut(List<int> cellIndices, Color color, float duration = 2f, int repetitions = 1) {
            ...
            for (int k = 0; k < cellCount; k++) {
                CellAnimate(FADER_STYLE.FadeOut, cellIndices[k], TGSConst.ColorNull, color, duration, repetitions);
            }
        }
        /// <summary>
        ...
        public void CellFlash(int cellIndex, Color color, float duration = 2f, int repetitions = 1) {
            CellAnimate(FADER_STYLE.Flash, cellIndex, TGSConst.ColorNull, color, duration, repetitions);
        }
        /// <summary>
        /// Flashes a cell with "color" and "duration" in seconds.
        /// </summary>
        ...
        public void CellFlash(List<int> cellIndices, Color color, float duration = 2f, int repetitions = 1) {
            ...
            int cellCount = cellIndices.Count;
            for (int k = 0; k < cellCount; k++) {
                CellAnimate(FADER_STYLE.Flash, cellIndices[k], TGSConst.ColorNull, color, duration, repetitions);
            }
        }
        /// <summary>
        ...
        public void CellColorTemp(int cellIndex, Color color, float duration = 2f) {
            CellAnimate(FADER_STYLE.ColorTemp, cellIndex, TGSConst.ColorNull, color, duration, 1);
        }
        /// <summary>
        /// Temporarily colors a cell for "duration" in seconds.
        /// </summary>
        public void CellColorTemp(Cell cell, Color color, float duration = 2f, int repetitions = 1) {
            int cellIndex = CellGetIndex(cell);
            CellAnimate(FADER_STYLE.ColorTemp, cellIndex, TGSConst.ColorNull, color, duration, repetitions);
        }
        /// <summary>
        ...
        public void CellColorTemp(List<int> cellIndices, Color color, float duration = 2f, int repetitions = 1) {
            ...
            int cellCount = cellIndices.Count;
            for (int k = 0; k < cellCount; k++) {
                CellAnimate(FADER_STYLE.ColorTemp, cellIndices[k], TGSConst.ColorNull, color, duration, repetitions);
            }
        }
        /// <summary>
        ...
        public void CellBlink(Cell cell, Color color, float duration = 2f, int repetitions = 1) {
            int cellIndex = CellGetIndex(cell);
            CellAnimate(FADER_STYLE.Blink, cellIndex, TGSConst.ColorNull, color, duration, repetitions);
        }
        /// <summary>
        /// Blinks a cell with "color" and "duration" in seconds.
        /// </summary>
        ...
        public void CellBlink(List<int> cellIndices, Color color, float duration = 2f, int repetitions = 1) {
            ...
            int cellCount = cellIndices.Count;
            for (int k = 0; k < cellCount; k++) {
                CellAnimate(FADER_STYLE.Blink, cellIndices[k], TGSConst.ColorNull, color, duration, repetitions);
            }
        }
        /// <summary>
        ...
        public void CellSetColor(int cellIndex, Color color) {
            CellToggleRegionSurface(cellIndex, true, color, false, null, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false, false);
        }
        /// <summary>
        /// Sets current cell's fill color. Use CellToggleRegionSurface for more options
        /// </summary>
        ...
        public void CellSetColor(List<int> cellIndices, Color color) {
            int cellCount = cellIndices.Count;
            for (int k = 0; k < cellCount; k++) {
                CellToggleRegionSurface(cellIndices[k], color.a > 0, color, false, null, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false, false);
            }
        }
        /// <summary>
        ...
        public GameObject CellGetGameObject(int cellIndex) {
            ...
            GameObject go = CellToggleRegionSurface(cellIndex, true, TGSConst.ColorNull);
            CellToggleRegionSurface(cellIndex, false, TGSConst.ColorNull);
            return go;
        }
        /// <summary>
        ...
        public void WarmCells() {
            ...
            for (int k = 0; k < cellCount; k++) {
                GenerateCellRegionSurface(k, mat, TGSConst.Vector2one, TGSConst.Vector2zero, 0, false);
            }
        }
        /// <summary>
