...
namespace CYM.UI
{
    public class UModalBoxView : UStaticUIView<UModalBoxView>
    {
        ...
        public new void ShowOKTitle(string key, Callback BntOK, params object[] paras)=> ShowStr(GetStr(key), GetStr(Const.Prefix_Desc + key, paras), GetStr(BntOKKey), BntOK, null, null, null, null, true);
        /// <summary>
        /// 语法糖对话框调用函数
        /// </summary>
        /// <param name="descKey"></param>
        ...
        /// <param name="paras"></param>
        public new void ShowOKCancleTitle(string key,Callback BntOK, Callback BntCancle = null, params object[] paras)=> ShowStr(GetStr(key), GetStr(Const.Prefix_Desc + key, paras), GetStr(BntOKKey), BntOK, GetStr(BntCancleKey), BntCancle, null, null, true);
