    ...
    public class UPosMap : UPres<UPosMapData>
    {
        ...
        public override void Refresh()
        {
                ...
                Data.Castles!=null)
            {
                ...
                ICapital.anchoredPosition = PosData.GetCastleMinMapPos(capital?.TrimStart(Const.Prefix_Castle));
                ...
                for (int i = 0; i < castleDatas.Count; ++i)
                {
                    ...
                    rect.anchoredPosition = PosData.GetCastleMinMapPos(castleID.TrimStart(Const.Prefix_Castle));
                }
