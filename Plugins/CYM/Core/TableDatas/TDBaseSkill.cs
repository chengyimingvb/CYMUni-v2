...
namespace CYM
{
    ...
    [Serializable]
    public class TDBaseSkillData : TDBaseData, IOnAnimTrigger, IPrespawner
    {
        #region const
        ...
        #region mgr
        protected BaseAudioMgr GlobalAudioMgr => BaseGlobal.AudioMgr;
        #endregion
        ...
        public virtual bool Release(SkillReleaseData? data = null)
        {
            ...
            if (CheckCondition(data))
            {
                ...
                if (IsCustomProcess)
                {
                    ...
                    coroutineHandle = BaseGlobal.BattleCorouter.Run(Custom_AffterRelease());
                }
                return true;
            }
            return false;
