...
namespace CYM
{
        ...
        where TType : Enum
    {
        ...
        protected TDBaseSkillData R_Skill { get; private set; } = null;
        ...
        // 获得buff的加成描述字符串组合
        public string GetAdtDesc(bool isNewLine = true, string splite = Const.STR_Indent)
        {
            string addition = "";
        ...
        public string GetAdtDescByLayer(int layer = 1, bool isNewLine = false, string splite = Const.STR_Indent)
        {
            string addition = "";
        ...
        protected virtual BasePerformMgr PerformMgr => SelfBaseUnit.PerformMgr;
        // 属性管理器
        protected virtual BaseAttrMgr<TType> AttrMgr => SelfBaseUnit.AttrMgr as BaseAttrMgr<TType>;//throw new NotImplementedException("AttrMgr:此函数没有被实现");
        #endregion
    }
