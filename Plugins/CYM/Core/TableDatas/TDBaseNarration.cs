...
namespace CYM
{
    ...
    public class NarrationFragment : TDBaseData
    {
        ...
        public override Sprite GetIcon()
        {
            ...
            var ret = BaseGlobal.GRMgr.Icon.Get(NarrationId + "_" + FragmentIndex, false);
            if(ret==null)
                ret = BaseGlobal.GRMgr.Icon.Get(NarrationId, false);
            return ret;
        }
        #endregion
    }
    ...
    public class TDBaseNarrationData : TDBaseData
    {
        ...
        public string Music { get; set; } = Const.STR_Inv;
