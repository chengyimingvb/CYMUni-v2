...
namespace CYM.Template
{
    ...
    public static class TemplateTool {
        ...
        {
            String targetPath = EditorUtil.GetDirectoryPathOfSelectedAsset();
            string templateFilePath = Path.Combine(Const.RPath_Uni, "_Res/Configs/TemplateFiles/" + name + ".asset"); 
            if (String.IsNullOrEmpty(targetPath))
                targetPath = "Assets";
            if (!File.Exists(templateFilePath))
                return;
        ...
        public static void CreateTemplate()
        {
            ...
            string rawPath = Path.Combine(Const.RPath_CustomTempScript, "NewTemplate.asset");
        ...
        public static void CreateMappingSet()
        {
            ...
            string rawPath = Path.Combine(Const.RPath_CustomTempScript, "NewTemplateMapping.asset"); 
            string uniquePath = AssetDatabase.GenerateUniqueAssetPath(rawPath);
