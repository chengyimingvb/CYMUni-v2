...
using CYM.AI.BT;
using Tree = CYM.AI.BT.Tree;
namespace CYM
{
    [CustomEditor(typeof(BaseModel), true)]
    public class IPTBaseModel : Editor
    {
        BaseModel charaModel;
        ...
        //    PreviewUtil.Header("属性:");
        //    foreach(var item in Attr)
        //    {
        //        EditorGUILayout.LabelField(item.Key+":"+ UIUtil.TwoD(item.Value));
        //    }
        ...
        void InitBone()
        {
            Bones = charaModel.GetComponentsInChildren<Bone>();
        }
        void DrawBone()
        {
            if (Bones == null)
