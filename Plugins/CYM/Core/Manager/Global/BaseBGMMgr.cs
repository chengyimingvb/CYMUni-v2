...
namespace CYM
{
    public class BaseBGMMgr : BaseGFlowMgr
    {
        ...
        {
            return GRMgr.Music.IsHave(name);
        }
        #endregion
        ...
        {
            return CreateConnection(BaseGlobal.GRMgr.Music.GetStrsByCategory(Config.StartMusics));
        }
        protected virtual SoundConnection CreateCreditsBGM()
        {
            return CreateConnection(BaseGlobal.GRMgr.Music.GetStrsByCategory(Config.CreditsMusics));
        }
        protected virtual SoundConnection CreateBattleBGM()
        {
            return CreateConnection(BaseGlobal.GRMgr.Music.GetStrsByCategory(Config.BattleMusics), SoundManager.PlayMethod.ShufflePlayThroughWithRandomDelayInRange);
        }
        #endregion
