...
namespace CYM
{
    ...
    public class TexProjectConstPathDrawer : BaseTexConstPathDrawer
    {
        ...
        public override void Init(Color c, string prefab)
        {
            ...
            if (ConstantPathProjectObj)
            {
                ...
                SourceTex = BaseGlobal.GRMgr.Texture.Get("HexTile2");
    ...
    public class PrefabConstPathDrawer
    {
        ...
        public virtual void Draw(List<GraphNode> nodes, Vector3? center = null)
        {
            ...
            if (nodes == null)
            {
                ConstantPathProjectObj.transform.position = Const.VEC_FarawayPos;
                return;
            }
    ...
    public class BasePathRenderMgr : BaseGFlowMgr
    {
        #region virtual
        protected override string ResourcePrefabKey => Const.STR_Inv;
        protected virtual string ConstantPathPrefab => Const.STR_Inv;
        #endregion
