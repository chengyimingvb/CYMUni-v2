...
namespace CYM
{
    ...
    public class PlatLeaderBoardItem
    {
        public ulong Id;
    ...
    /// 计分板数据
    /// </summary>
    public class PlatLeaderBoard
    {
        public List<PlatLeaderBoardItem> Items = new List<PlatLeaderBoardItem>();
    }

    /// <summary>
    /// 平台好友数据
    /// </summary>
    public class PlatFriend
    {
        public ulong ID;
        public string Name;
    ...
    public class BasePlatSDKMgr : BaseGFlowMgr
    {
        ...
        /// 好友数据
        /// </summary>
        public List<PlatFriend> Friends { get; protected set; } = new List<PlatFriend>();
        /// <summary>
        /// 好友id
        /// </summary>
        ...
        /// 排行榜
        /// </summary>
        public Dictionary<string, PlatLeaderBoard> LeaderBoards { get; protected set; } = new Dictionary<string, PlatLeaderBoard>();
        /// <summary>
        /// 刷行排行榜
        /// </summary>
        /// <param name="id"></param>
        ...
        /// 获取计分成功
        /// </summary>
        public Callback<PlatLeaderBoard> Callback_OnFatchScoreSuccess { get; set; }
        /// <summary>
        /// 获取计分失败
        /// </summary>
