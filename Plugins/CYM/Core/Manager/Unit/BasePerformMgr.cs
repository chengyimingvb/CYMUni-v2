...
namespace CYM
{
    public class BasePerformMgr : BaseMgr
    {
        ...
        public virtual BasePerform SpawnGO(GameObject prefab, BaseCoreMono target, Vector3? position = null, Quaternion? quaternion = null)
        {
            ...
            if (BaseGlobal.PoolMgr.Perform == null) return null;
            var temp = BaseGlobal.PoolMgr.Perform.Spawn(prefab, position, quaternion);
            ...
            where T : BasePerform
        {
            ...
            if (BaseGlobal.PoolMgr.Perform == null) return null;
            var temp = BaseGlobal.PoolMgr.Perform.Spawn(BaseGlobal.GRMgr.Perfom.Get(performName), position, quaternion);
        ...
        public void Despawn(BasePerform perform, bool isRemove = true)
        {
            if (perform != null)
            {
                ...
                BaseGlobal.PoolMgr?.Perform.Despawn(perform, closeTime);
            }
        }
