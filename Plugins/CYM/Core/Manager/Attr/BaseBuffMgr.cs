...
namespace CYM
{
        ...
        where TType : Enum
    {
        ...
        #region life
        //通用的转换buff
        public virtual string ConvertBuff => Const.STR_Inv;
        ...
        public string GetTableDesc(List<string> ids, bool newLine = false, string split = Const.STR_Indent, float? anticipationFaction = null, bool appendHeadInfo = false)
        {
            return GetDesc(GetTableBuffs(ids), newLine, split, anticipationFaction, appendHeadInfo);
        }
        // 拼接所有传入的buff addtion 的字符窜
        public string GetTableDesc(string id, bool newLine = false, string split = Const.STR_Indent, float? inputVal = null, bool appendHeadInfo = false)
        {
        ...
        // 拼接所有传入的buff addtion 的字符窜
        public string GetDesc(List<TData> buffs, bool newLine = false, string split = Const.STR_Indent, float? anticipationFaction = null, bool appendHeadInfo = false)
        {
            string showStr = "";
            int index = 0;
        ...
        public string GetDesc(string buff, bool newLine = false, string split = Const.STR_Indent, float? inputVal = null, bool appendHeadInfo = false)
        {
            return GetDesc(Get(buff), newLine, split, inputVal, appendHeadInfo);
        }
        // 通过所有传入的buff获得加成字符窜
        public string GetDesc(TData buff, bool newLine = false, string split = Const.STR_Indent, float? inputVal = null, bool appendHeadInfo = false)
        {
            string showStr = "";
            if (buff == null) return "";
            if (appendHeadInfo)
