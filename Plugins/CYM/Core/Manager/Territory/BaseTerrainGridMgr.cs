...
namespace CYM
{
    ...
    {
        #region prop
        const string SplatMapIntDataFileName = "SplatMapIntData";
        ...
        public BinData<SplatMapIntData> SplatMapIntBinData { get; private set; } = new BinData<SplatMapIntData>("Temp/" + SplatMapIntDataFileName);
        #endregion
        ...
        public void ExportSplatMapIntData()
        {
            ...
            FileUtil.SaveBin(Path.Combine(Const.Path_ResourcesText, SplatMapIntDataFileName + ".bytes"), SplatMapIntData);
        }
        #endregion
        ...
        protected virtual void OnTerritoryClick(TGS.TGS sender, int territoryIndex, int buttonIndex) { }
        protected virtual void OnTerritoryExit(TGS.TGS sender, int territoryIndex) { }
        protected virtual void OnTerritoryEnter(TGS.TGS sender, int territoryIndex) { }
        protected virtual void OnCellClick(TGS.TGS sender, int cellIndex, int buttonIndex) { }
        protected virtual void OnCellExit(TGS.TGS sender, int cellIndex) { }
        protected virtual void OnCellEnter(TGS.TGS sender, int cellIndex) { }
