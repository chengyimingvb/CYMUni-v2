...
namespace CYM.Waypoint
{
    ...
    public class PathEditor : Editor
    {
        ...
        private SerializedProperty m_SpineMovePrefab;
        ...
        */
        ...
        public void OnEnable()
        {
            ...
            m_SpineMovePrefab = m_Object.FindProperty("AutoSplineMovePrefab");
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_SpineMovePrefab.objectReferenceValue = EditorGUILayout.ObjectField("SpineMovePrefab",m_SpineMovePrefab.objectReferenceValue, typeof(SplineMove));
        ...
        void OnSceneGUI()
        {
            ...
            for (int i = 0; i < waypoints.Length; i++)
            {
                ...
                var fmh_303_47_637945286071384439 = Quaternion.identity; Handles.FreeMoveHandle(wpPos, size, Vector3.zero, (controlID, position, rotation, hSize, eventType) => 
                {
