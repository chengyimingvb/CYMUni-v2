...
namespace CYM.Waypoint
{
    ...
    public class SplineMove : MonoBehaviour
    {
        ...
        public bool isAdjtoTerrain = true;
        /// <summary>
        ...
        private void CreateTween()
        {
                ...
                waypointRotation != RotationType.none)
            {
                ...
                parms.OnUpdate(OnPathUpdate);
            }
            else
            {
                parms.OnUpdate(OnPathUpdateNormal);
            }
            //parms.OnUpdate(OnPathUpdate);
        ...
        private void OnPathUpdateNormal()
        {
            if (isAdjtoTerrain && Terrain.activeTerrain != null)
                transform.position = transform.position.SetY(Terrain.activeTerrain.SampleHeight(transform.position));
        }
