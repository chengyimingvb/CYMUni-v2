...
namespace CYM.Waypoint
{
    ...
    {
        [SerializeField]
        SplineMove AutoSplineMovePrefab;
        /// <summary>
        ...
        void Awake()
        {
            ...
            if (AutoSplineMovePrefab != null)
            {
                var temp = Instantiate(AutoSplineMovePrefab);
                temp.transform.parent = transform;
                temp.transform.position = waypoints[0].position;
                temp.pathContainer = this;
            }
        }
