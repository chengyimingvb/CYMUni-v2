...
namespace CYM.Cam
{
    ...
    public class RTSCamera3D : MonoBehaviour
    {
        ...
        public bool IsMoving
        {
            ...
            {
                return
                    !BaseMathUtil.Approximately(self.trans.position.x, objectPos.x, 0.02f) ||
                    !BaseMathUtil.Approximately(self.trans.position.y, objectPos.y, 0.02f) ||
                    !BaseMathUtil.Approximately(self.trans.position.z, objectPos.z, 0.02f);
            }
        }
        #endregion
